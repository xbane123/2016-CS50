...
$(function() {
    ...
    var options = {
        center: {lat: 38.2811, lng: -77.126}, // Stanford, California
...
function addMarker(place, timeout)
{
    window.setTimeout(function() {
        ...
        // specify the icon image. From https://mapicons.mapsmarker.com
        var image = { url: 'static/crow2.png',    
